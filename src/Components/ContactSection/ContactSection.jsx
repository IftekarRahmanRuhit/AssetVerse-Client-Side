          ...
          <div className="bg-purple-50 rounded-xl p-8 md:p-10">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-base font-medium text-gray-900">Email Us</p>
                  <p className="mt-1 text-sm text-gray-600">
                    <a href="mailto:support@assetverse.com" className="text-gray-600 ">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-base font-medium text-gray-900">Call Us</p>
                  <p className="mt-1 text-sm text-gray-600">
                    <a href="tel:+18005551234" className="text-gray-600">
                      +1 (800) 555-1234
                    </a>
                  </p>
                </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-base font-medium text-gray-900">Operating Hours</p>
                  <p className="mt-1 text-sm text-gray-600">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-base font-medium text-gray-900">Headquarters</p>
                  <p className="mt-1 text-sm text-gray-600">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="input input-bordered focus:outline-none focus:ring-2 focus:ring-[#9538E2]  text-black block w-full sm:text-sm border-gray-300 rounded-md p-3"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="border input-bordered focus:outline-none focus:ring-2 focus:ring-[#9538E2]  text-black block w-full sm:text-sm border-gray-300 rounded-md p-3"
                      ...
                      <div className="mt-4">
                        <div className="space-y-4">
                          <div>
                            <input
                              type="text"
                              className="input input-bordered focus:outline-none focus:ring-2 focus:ring-[#9538E2]  text-black block w-full sm:text-sm border-gray-300 rounded-md p-2"
                          ...
                          <div>
                            <textarea
                              rows={3}
                              className="border input-bordered focus:outline-none focus:ring-2 focus:ring-[#9538E2]  text-black block w-full sm:text-sm border-gray-300 rounded-md p-2"
