    ...
    <div>
      <div className="max-w-screen-2xl mx-auto">
        <footer className="bg-gradient-to-r from-[#d8c6f2] via-[#e6dbf7] to-[#d8c6f2] text-white py-8 px-4">
            ...
            <div>
              ...
              <form className="mt-4 flex items-center space-x-2">
                <input
                  ...
                  className="w-full px-4 py-2 rounded bg-gray-100 text-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-700"
                />
                <button
                  type="submit"
          ...
          <div className="border-t border-[#9538E2] mt-8 pt-4 text-center text-sm text-gray-900">
            <p>
