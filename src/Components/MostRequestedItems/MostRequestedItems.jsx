...
const MostRequestedItems = () => {
  ...
  return (
    <div className=" rounded-lg p-6">
      <h2 className="text-2xl text-center font-bold text-gray-900 mb-6">Most Requested Items</h2>
      ...
      {mostRequestedItems.length === 0 ? (
        <div className="flex flex-col md:flex-row items-center justify-center bg-gray-800 rounded-lg p-6">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h3 className="text-xl font-semibold text-gray-100 mb-3">No Top Requested Items</h3>
            ...
            <div key={item._id} className="flex justify-center">
              <div className="w-full h-[280px] relative overflow-hidden group cursor-pointer rounded-md">
                ...
                <div className="absolute top-[50%] transform group-hover:translate-y-[-50%] transition-all duration-500 w-full h-full left-0 z-20 right-0 flex items-center justify-center flex-col px-4">
                  ...
                  <button
                    className="z-[1-] opacity-0 group-hover:z-20 group-hover:opacity-100 px-6 py-2 mt-3 rounded-md text-[0.9rem] transition-all duration-1000 bg-blue-600 hover:bg-blue-700 text-white"
                  >
                    View Details
                  </button>
                </div>
