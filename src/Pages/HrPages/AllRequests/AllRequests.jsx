                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-4'>
                          <button
                            ...
                            className='disabled:opacity-50 disabled:cursor-not-allowed text-gray-500 transition-colors duration-200 hover:text-green-500 focus:outline-none'
                          >
                            <svg
                          ...
                          <button
                            ...
                            className='disabled:opacity-50 disabled:cursor-not-allowed text-gray-500 transition-colors duration-200 hover:text-red-500 focus:outline-none'
                          >
                            <svg
                              xmlns='http://www.w3.org/2000/svg'
                              fill='none'
